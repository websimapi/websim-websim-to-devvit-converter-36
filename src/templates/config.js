...
export const generateDevvitJson = (slug, launchMode = 'inline') => {
  const entrypoints = launchMode === 'launcher' 
    ? {
        "default": {
          "entry": "preview.html",
          "height": "regular",
...
export const generateClientViteConfig = ({ hasReact = false, hasRemotion = false, launchMode = 'inline' } = {}) => `
